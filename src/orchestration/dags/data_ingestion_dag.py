...
ingest_web_logs = SparkSubmitOperator(
    ...
    jars='/opt/jars/hadoop-aws-3.3.1.jar,/opt/jars/aws-java-sdk-bundle-1.11.901.jar,/opt/jars/wildfly-openssl-1.0.7.Final.jar,/opt/spark/jars/spark-sql-kafka-0-10_2.12-3.3.1.jar,/opt/spark-jars/spark-token-provider-kafka-0-10_2.12-3.3.1.jar,/opt/spark-jars/kafka-clients-2.8.1.jar',
    dag=dag,
)
